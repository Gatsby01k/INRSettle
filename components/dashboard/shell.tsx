  ...
  return (
    <div className="app-surface min-h-screen text-slate-950">
      ...
      <div className="lg:pl-[272px]">
        <header className="relative sticky top-0 z-20 flex h-16 items-center justify-between gap-3 border-b border-[var(--ops-line)] bg-white/88 px-4 backdrop-blur-xl sm:px-6">
        ...
        <main className="mx-auto w-full max-w-[1500px] space-y-6 px-4 pb-28 pt-5 sm:px-6 sm:pb-24 sm:pt-6 lg:p-8">
          {children}
        </main>
      </div>
      <MobileDock />

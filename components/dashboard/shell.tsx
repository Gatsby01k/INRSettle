  ...
  return (
    <div className="app-surface min-h-screen text-slate-950">
      ...
      <div className="lg:pl-60">
        <header className="sticky top-0 z-20 flex h-14 items-center justify-between gap-3 border-b border-[var(--ops-line)] bg-white/95 px-4 backdrop-blur-lg sm:px-6">

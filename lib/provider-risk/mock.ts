...
export const PROVIDER_RISK_PROFILES: ProviderRiskProfile[] = [
  {
    ...
    passport: [
      ...
      { label: "Prefunding readiness", value: "Float, top-up and cut-off terms undefined", state: "pending" },
  ...
  },
  {
    ...
    passport: [
      ...
      { label: "Prefunding readiness", value: "No prefunding terms received", state: "blocked" },
